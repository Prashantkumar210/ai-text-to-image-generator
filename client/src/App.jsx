...
function App() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (err.code === 'ECONNABORTED') {
        ...
        setError('Network error. Please make sure the server is running on http://localhost:4000')
  ...
  const handleThumbnailClick = (imageUrl) => {
    setImage(imageUrl)
    // Scroll to top of image preview
  ...
  const handleDownload = async () => {
    try {
      ...
      img.onload = () => {
        ...
        }, 'image/jpeg', 0.9) // 0.9 quality for JPG
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-800 dark:to-indigo-900 p-6 text-white">
          ...
          <p className="text-center text-purple-100 dark:text-purple-200 mt-2 text-sm md:text-base">
        ...
        <div className="p-6 md:p-8 dark:bg-gray-800">
          {/* Input Section */}
          <div className="mb-6">
            <label htmlFor="prompt" className="block text-gray-700 dark:text-gray-300 font-semibold mb-2">
              Enter your prompt
            </label>
            <textarea
              id="prompt"
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 border-2 border-gray-200 dark:border-gray-600">
                ...
                <div className="mt-4 flex gap-3">
                  <a
                    ...
                    className="flex-1 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 text-gray-800 dark:text-gray-200 font-medium py-2 px-4 rounded-lg text-center transition-colors"
                  >
                    Open in New Tab
                  </a>
                  <button
                    onClick={handleDownload}
                    className="flex-1 bg-purple-600 dark:bg-purple-700 hover:bg-purple-700 dark:hover:bg-purple-600 text-white font-medium py-2 px-4 rounded-lg transition-colors"
                  >
                    Download Image
                  </button>
                </div>
        ...
        {/* Gallery Section */}
        {gallery.length > 0 && (
          <div className="w-full bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-800 dark:to-indigo-900 p-6 text-white">
            <h2 className="text-2xl md:text-3xl font-bold text-center">
              Image Gallery
            </h2>
            <p className="text-center text-purple-100 dark:text-purple-200 mt-2 text-sm md:text-base">
              {gallery.length} {gallery.length === 1 ? 'image' : 'images'} generated
            </p>
          </div>
          ...
          <div className="p-6 dark:bg-gray-800">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
              {gallery.map((item, index) => (
                <div
                  key={index}
                  className="group relative aspect-square bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden cursor-pointer transform transition-all hover:scale-105 hover:shadow-lg"
